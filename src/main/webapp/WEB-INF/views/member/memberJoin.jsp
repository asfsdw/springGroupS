...
<div class="container">
	<form name="myform" method="post" enctype="multipart/form-data" class="was-validated">
		...
		<div class="input-group mb-3">
			...
			<input type="number" name="tel2" id="tel2" min="0" max="9999" class="form-control" />
			<span class="input-group-text">-</span>
			<input type="number" name="tel3" id="tel3" min="0" max="9999" class="form-control" />
		</div>
		<div class="input-group mb-3">
		...
		<div class="input-group mb-3 border ">
			<span class="input-group-text boxWidth">정보공개여부</span> &nbsp; &nbsp;
			<div class="form-check-inline mt-2">
				<label class="form-check-label">
