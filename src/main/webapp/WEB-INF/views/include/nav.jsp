		...
		<c:if test="${sLevel < 3}">
			...
			<div class="w3-dropdown-hover w3-hide-small">
				...
				<div class="w3-dropdown-content w3-bar-block w3-card-4">
					...
					<a href="${ctp}/study2/crawling/Jsoup" class="w3-bar-item w3-button">크롤링 연습(jsoup)</a>
					<a href="${ctp}/study2/crawling/selenium" class="w3-bar-item w3-button">크롤링 연습(selenium)</a>
				</div>
			</div>
			<div class="w3-dropdown-hover w3-hide-small">
